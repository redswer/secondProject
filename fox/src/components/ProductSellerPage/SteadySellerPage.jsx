    ...
    <div className='seller_page_container'>
      ...
      <div className='seller_product_List_container'>
        <div className='seller_product_page_titlebox'>
          <span className='seller_product_page_title'>스테디 셀러</span>
          <span className='seller_product_page_sub_title'>최근 5년간 꾸준히 판매되는 도서 순위입니다.</span>
        </div>
...
export default SteadySellerPage;
