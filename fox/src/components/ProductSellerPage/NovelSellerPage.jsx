    ...
    <div className='seller_page_container'>
      ...
      <div className='seller_product_List_container'>
        <div className='seller_product_page_titlebox'>
          <span className='seller_product_page_title'>소설</span>
          <span className='seller_product_page_sub_title'>작가의 풍부한 상상력이 만들어낸 세계로 빠져들어보세요.</span>
        </div>
...
export default NovelSellerPage;
